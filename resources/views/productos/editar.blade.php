        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @method('PUT')
                ...
                <div class="grid grid-cols-1">
                    ...
                    <input name="stock" value="{{ $producto->stock }}" class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="number" required/>
                </div>
                </div>
                ...
                <a href="{{ route('productos.index') }}" class='w-auto bg-gray-500 hover:bg-gray-700 rounded-lg shadow-xl font-medium text-black px-4 py-2'>Cancelar</a>
                <button type="submit" class='w-auto bg-purple-500 hover:bg-purple-700 rounded-lg shadow-xl font-medium text-black px-4 py-2'>Guardar</button>
                </div>
            </form>
            </div>
        </div>
